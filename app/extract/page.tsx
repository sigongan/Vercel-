...
export default function ExtractPage() {
  return (
    <main className="relative flex-1 flex flex-col items-center justify-center gap-8 px-5 py-10 pb-28 bg-gradient-to-b from-[#FAFAF7] via-[#F4F6EE] to-[#FAFAF7] dark:bg-stone-950 dark:from-transparent dark:via-transparent dark:to-transparent">
      <div
        aria-hidden
