    ...
    <main className="relative flex-1 flex flex-col items-center gap-4 px-5 py-8 pb-28 bg-[#FAFAF7] dark:bg-stone-950">
      <div className="flex w-full max-w-2xl items-center gap-3 pb-1">
        <button
          ...
          aria-label={t.back}
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-[#232920] transition-colors hover:bg-[#EDF1E4] dark:text-stone-100 dark:hover:bg-stone-800"
        >
          <BackIcon />
        </button>
        ...
        {LANGUAGES.map((code) => {
          ...
          return (
            <button
              ...
              className="flex w-full items-center justify-between gap-3 px-5 py-3.5 text-left transition-colors hover:bg-[#FCFCF9] dark:hover:bg-stone-800/40"
            >
  ...
  return (
    <span
      className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 transition-colors ${
        active ? "border-[#61A00E]" : "border-[#DCE2D2] dark:border-stone-700"
      }`}
    >
